    ...
    <div className='search-bar'>
        ...
        <div className='searching-components'>
          ...
          <div className='location-icon' onClick={() => handleUserLocation()}>
            <div style={{height: "32.5px", width: "32.5px", background: "var(--secondary)", borderRadius: "50%", position: "absolute", left: "50%", top: "35%", transform: "translate(-50%, -50%)"}}></div>
            ...
            <div style={{borderLeft: "13px solid transparent", borderRight: "13px solid transparent", borderTop: "20px solid var(--secondary)", position: "absolute", left: "50%", top: "74%", transform: "translate(-50%, -50%)"}}></div>
        </div>  
        </div>
    </div>
  )
